...
```
INSERT INTO MGR VALUES(1000, 'Hong Gil-dong', '010-1234-5678');
SELECT * FROM MGR;
COMMIT;
```
...
```
INSERT INTO MGR VALUES('1000', 'Hong Gil-dong', '010-1234-5678', 'Seoul Gangnam-gu');
SELECT * FROM MGR;
COMMIT;
```
...
```
-- If there is a view with the same name when creating a view, delete the view and create a new view - same as modifying the view
```
